## Goal
Implement final UI/UX hard TZ changes (boomerang, header, profile, content visuals, style consistency).

## Plan
- [x] Locate "boomerang" component and replace with bottom sheet drawer.
