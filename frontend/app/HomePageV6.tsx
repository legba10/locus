    ...
    <div className="home-tz18 home-tz3 home-tz6 min-h-screen font-sans antialiased bg-[var(--background)]">
        ...
        <div className="home-search-sticky-tz5 fixed left-0 right-0 z-[80] h-[72px] flex items-center gap-3 px-4 md:px-6 bg-[var(--card-bg)] border-b border-[var(--border)] shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
          <div className="market-container w-full max-w-[1200px] mx-auto flex flex-wrap items-center gap-2 md:gap-4">
            ...
            <select
              ...
              className="home-search-sticky-tz5__budget h-9 rounded-lg card-tz47 bg-[var(--card)] px-2 text-[13px] text-[var(--text-main)] w-28 md:w-36"
            >
            ...
            <button type="button" onClick={handleScrollToFilter} className="h-9 px-3 rounded-lg card-tz47 text-[13px] font-medium text-[var(--text-main)]" aria-label="Фильтры">
              Фильтры
            </button>
        ...
        <div className="home-filter-outer">
          ...
          {filterSheetOpen && (
            <>
              ...
              />
              <div
                className="home-filter-dropdown-tz12 home-filter-modal-tz9 hidden md:flex flex-col fixed left-1/2 -translate-x-1/2 w-[calc(100%-32px)] max-w-[1100px] rounded-[20px] card-tz47 shadow-xl text-[var(--text-main)]"
          ...
          {allListingCards.length > 0 && allListingCards.length >= allListingsLimit && (
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="px-6 py-3 rounded-xl card-tz47 text-[var(--text-main)] font-medium text-[14px] hover:opacity-90 transition-opacity disabled:opacity-60"
              >
      ...
      {canUseAi && (
        <section className="home-tz6-block" aria-label="Умный подбор">
          <div className="market-container">
            <div className="w-full max-w-[900px] mx-auto rounded-[20px] card-tz47 p-4 md:p-5">
      ...
      <section className="home-tz6-block" aria-label="Новости рынка">
        <div className="market-container">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-5">
            {/* Новость 1 — Рост цен */}
            <article className="group card-tz47 rounded-xl overflow-hidden transition-shadow">
      ...
      >
        <div className="market-container">
          <div className={cn(
            'rounded-[20px] card-tz47 backdrop-blur-[22px]',
            'p-8 md:p-10'
          )}>
