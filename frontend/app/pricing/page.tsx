    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-white to-[#F7F8FA]">
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        <div className="text-center mb-10 md:mb-12">
          ...
          {reason === 'host' && (
            <div className="mt-5 inline-flex items-center gap-2 rounded-[14px] bg-violet-50 px-4 py-2 text-[13px] text-violet-700">
              Чтобы разместить объявление, нужен тариф для сдачи жилья.
            </div>
          )}
        </div>
        ...
        <div
          className={cn(
            'grid gap-6',
            userType === 'landlord' ? 'grid-cols-1 md:grid-cols-3' : 'grid-cols-1 md:grid-cols-2 md:max-w-4xl md:mx-auto'
          )}
        >
          {plans.map((plan) => (
